...
public class Lichgiangday_teacher extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lichgiangday_teacher);
        ...
        Lichgiangday_Adapter adapter = new Lichgiangday_Adapter(Lichgiangday_teacher.this,R.layout.listview_lichgiangday,mangMonhoc);
    ...
    private void Anhxa(){
        ...
        btnsang = findViewById(R.id.Btn_sang);
        btnchieu = findViewById(R.id.Btn_chieu);
        btntoi = findViewById(R.id.Btn_toi);
        ngaybd = findViewById(R.id.tv_thoigianbd);
        ngaykt = findViewById(R.id.tv_thoigiankt);
        btntuansau = findViewById(R.id.btntuansau);
        btntuantruoc = findViewById(R.id.btntuantruoc);
        lvlichgd = findViewById(R.id.Lvlichgiangday);
